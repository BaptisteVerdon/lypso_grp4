        ...
        <ul>
            ...
            <?php
                if (userData_getNameRoleFromId() == 'employee'){
                    echo '<li><a href="../www/index.php?control=dayOff&action=employeeIndex&user_id='.$_SESSION['user']['id'].'">Congés</a></li>';
                    ...
                    echo '<li><a href="../www/index.php?control=dayOff&action=managerIndex&user_id='.$_SESSION['user']['id'].'">Manage</a></li>';
